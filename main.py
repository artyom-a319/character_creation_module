...
def start_training(char_name, char_class):
    ...
    print(
        ...
        f"— чтобы блокировать атаку противника или special "
        f"— чтобы использовать свою суперсилу."
    )
...
def choice_char_class():
    ...
    while approve_choice != "y":
        char_class = input(
            ...
            f"Воитель — warrior, Маг — mage, Лекарь — healer: "
        )
        if char_class == "warrior":
            print(
        ...
        approve_choice = input(
            ...
            f"чтобы выбрать другого персонажа "
        ).lower()
    return char_class
